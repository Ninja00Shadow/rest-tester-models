 ...
 * </p>
 * <ul>
 *   <li>{@link rest_tester.rest_tester.impl.NotExprImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotExprImpl extends BoolExprImpl implements NotExpr {
	...
	protected EClass eStaticClass() {
		return Rest_testerPackage.Literals.NOT_EXPR;
	}
	...
	public NotificationChain basicSetExpr(BoolExpr newExpr, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Rest_testerPackage.NOT_EXPR__EXPR, oldExpr, newExpr);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newExpr != expr) {
			...
			if (expr != null)
				msgs = ((InternalEObject) expr).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Rest_testerPackage.NOT_EXPR__EXPR, null, msgs);
			if (newExpr != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Rest_testerPackage.NOT_EXPR__EXPR, newExpr, newExpr));
	}
